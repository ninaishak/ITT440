...
public class SNMP4J {
    ...
    public static final int mSNMPVersion = 0; // 0 represents SNMP4J version = 1
...
//    }
    ...
    */
    public void snmpSet(String strAddress, String community, String strOID, int Value)
    {
        ...
        Address targetAddress = (Address) GenericAddress.parse(strAddress);
        Snmp snmp;
        try
        {
    ...
    */
    public String snmpGet(String strAddress, String community, String strOID)
    {
        ...
        try
        {
            ...
            strAddress= strAddress + "/" + 161;
            UdpAddress targetaddress = new UdpAddress(strAddress);
            TransportMapping transport = new DefaultUdpTransportMapping();
            transport.listen();
